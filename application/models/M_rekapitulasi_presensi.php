...
class M_rekapitulasi_presensi extends CI_Model
{

    var $table      = "tb_rekapitulasi_presensi";
    ...
    {
        $this->db->select("*");
        $this->db->from("tb_rekapitulasi_presensi rp");
        $this->db->join("tb_pegawai p", "p.id_pegawai = rp.id_pegawai", "left");
    ...
    function loadDataRekapitulasiPresensiDatatables()
    {
